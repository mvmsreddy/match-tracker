...
create table if not exists public.matches (
  ...
  indoor_outdoor text,
  opp_handedness text,
  playing_style text,                  -- e.g. 'Baseliner', 'Serve & Volley'
  rank_seed text,                      -- freeform, e.g. 'State Rank 12, Seed 4'
...
-- Migration for existing tables created before these columns were added.
