          ...
          <div className="space-y-2.5">
            {activePlayers.map(p => {
              ...
              return (
                ...
                >
                  <div className="shrink-0 w-11 h-11 rounded-full bg-primary/10 text-accent-ink flex items-center justify-center font-bold text-sm">
                    {initials}
                  </div>
                  ...
                  <ChevronRight className="w-5 h-5 text-muted-foreground group-hover:text-accent-ink shrink-0 transition-colors" />
                </Link>
              );
            })}
          </div>
