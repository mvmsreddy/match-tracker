            ...
            <Card className="p-4 sm:p-6">
              ...
              <ResponsiveContainer width="100%" height={200}>
                <AreaChart data={selectedCircuit.points} margin={{ top: 8, right: 12, left: -12, bottom: 0 }}>
                  ...
                  <Tooltip content={<ChartTooltip valueLabel="Points" />} cursor={{ stroke: 'hsl(var(--color-border))', strokeDasharray: '3 3' }} />
                  <Area type="monotone" dataKey="totalPoints" stroke="hsl(var(--color-primary))" strokeWidth={2} fill="hsl(var(--color-primary))" fillOpacity={0.1} dot={false} activeDot={{ r: 5, stroke: 'hsl(var(--color-card))', strokeWidth: 2, fill: 'hsl(var(--color-primary))' }} />
                </AreaChart>
              </ResponsiveContainer>
            </Card>
